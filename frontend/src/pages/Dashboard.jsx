...
const Dashboard = () => {
  ...
  useEffect(() => {
    const loadStats = () => {
      ...
      // 👇 user name fetch
      const storedUser = localStorage.getItem("dreamhubUser");
      if (storedUser) {
    ...
    window.addEventListener("streakUpdated", loadStats);
...
p-6 text-white transition duration-300">
        <h1 className="text-3xl font-bold mb-6 text-center"> Hi {userName ? formatName(userName) : "User"} 👋, Welcome to your Dashboard 🚀</h1>
