...
// {/* <div className="min-h-screen 
// bg-gray-900 text-gray-100 transition duration-300">       */}
...
//     className="bg-indigo-600 px-8 py-3 rounded-full font-semibold
...
//     className="border border-gray-600 px-8 py-3 rounded-full font-semibold
...
// <section ref={statsRef} className="py-16 bg-gray-800 text-gray-100">
...
//     ].map((s, i) => (
//       <div key={i} className="p-6 rounded-2xl bg-gray-900 shadow hover:shadow-xl transition">
...
//       <div
//         key={i}
//         className="bg-gray-800 p-6 rounded-2xl shadow hover:shadow-2xl hover:-translate-y-2 transition"
//       >
...
//       <div
//         key={i}
//         className="bg-gray-900 p-6 rounded-2xl shadow hover:shadow-2xl transition hover:-translate-y-2"
//       >
//         <p className="italic mb-4 text-gray-300">“{u.review}”</p>
//         <h4 className="font-semibold text-yellow-400">— {u.name}</h4>
//       </div>
//     ))}
//   </div>
// </section>
...
//           className="w-full text-left p-4 font-semibold flex justify-between items-center hover:bg-gray-800"
//         >
//           {f.q}
...
//     {openFaq === i && (
//       <div className="p-4 pt-0 text-gray-400 animate-fadeInUp">
//         {f.a}
//       </div>
//     )}
//   </div>
...
//   </h2>
//   <p className="mb-6 text-gray-300">Start practicing today 🚀</p>

// <button
// onClick={handleSpeakNow}
// className="bg-yellow-400 text-gray-900 px-10 py-4 rounded-full font-bold text-lg
// hover:scale-105 hover:bg-yellow-300 transition-all duration-300 shadow-xl"
...
return ( <div className="min-h-screen bg-blue-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition duration-300">
  ...
  <section className="min-h-screen flex items-center justify-center px-4">
    <div className="max-w-4xl text-center">
      ...
      <div className="flex justify-center gap-4 flex-wrap">
        ...
        <button
          onClick={() => navigate("/vocab")}
          className="border border-gray-400 dark:border-gray-600 px-8 py-3 rounded-full font-semibold
          hover:bg-gray-200 dark:hover:bg-gray-800 hover:scale-105 transition-all duration-300"
        >
          📘 Learn Vocab
        </button>
      </div>
  ...
  {/* CTA */}
  <section className="py-20 text-center bg-indigo-600 dark:bg-gray-800 text-white">
    <h2 className="text-3xl sm:text-4xl font-bold mb-4">
      Ready to improve your English?
    </h2>
